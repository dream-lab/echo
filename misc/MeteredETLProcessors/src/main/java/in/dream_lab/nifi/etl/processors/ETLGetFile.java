...
import in.dream_lab.nifi.etl.processors.attributes.ExperimentCommons;
...
public class ETLGetFile extends AbstractProcessor {
    ...
    //private final Path expLogFile = Paths.get(ExperimentCommons.EXPERIMENT_LOG);
    PrintWriter expLogStream;
    private long flowfileCount = 0;
    ...
    private void openFile(String filename, ComponentLog logger) {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        openFile(context.getProperty(EXPERIMENT_LOG_FILE).getValue(), logger);
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                flowFile = session.putAttribute(flowFile, ExperimentAttributes.FLOWFILE_ID.key(), Long.toString(++flowfileCount));
