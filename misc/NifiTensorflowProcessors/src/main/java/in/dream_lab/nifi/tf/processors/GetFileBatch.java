...
public class GetFileBatch extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        final int batch_size = Integer.parseInt(context.getProperty(BATCH_SIZE).getValue());
        ...
        try {
            ...
            /*while (itr.hasNext()) {
				...
				/
                 * Adding Batch Id as Attribute to Flowfile
                 * Unique Id for a batch of N files
                 * N= 10 for now ----->
                 /

                if(count >9) { // ---> Replace 9 with a property 'COUNT'
                	batchId++;
                	count = 0;
                }
                count++;
