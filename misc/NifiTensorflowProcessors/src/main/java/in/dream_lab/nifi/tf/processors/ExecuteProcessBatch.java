...
public class ExecuteProcessBatch extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        final String arguments = context.getProperty(COMMAND_ARGUMENTS).isSet()
         ...
         List<String> commandStrings = createCommandStrings(context, command, arguments);
         commandStrings.set(2, commandStrings.get(2)+"/"+batchID);
         flowFile = session.putAttribute(flowFile, "sourceDir",commandStrings.get(2));
