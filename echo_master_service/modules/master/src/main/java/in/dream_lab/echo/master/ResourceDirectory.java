...
public class ResourceDirectory {
	...
	private final String DATAFLOW_QUERY = "prefix-href=/dataflow/";
	private final String DATAFLOW_POST = "href=/dataflow/";
	private final String DEVICE_QUERY = "prefix-href=/device";
	private final String INPUT_STREAM_QUERY = "prefix-href=/device/input_stream";
	private final String PATH = "/cat";
	private final String HOST;
	private final int PORT;
	
	public ResourceDirectory(String ip_address, int port) {
	...
	public String getAllDataflows() {
		StringBuffer response = null;
		try {
			URL obj = new URI(PROTOCOL, null, HOST, PORT, PATH, DATAFLOW_QUERY, null).toURL();
	...
	private String searchDataFlows(String dataFlowUUID){
		...
		try{
			...
			String query = DATAFLOW_QUERY + dataFlowUUID;
	...
	private void populateDevice(Object item, HashMap<String, Device> deviceMap){
		...
		System.out.println(linkedItem.get("href"));
	...
	private String searchDeviceMetaData(){
		...
		try{
			/*TODO: get rid of this hardcoded URL*/
			URL obj = new URI(PROTOCOL, null, HOST, PORT, PATH, DEVICE_QUERY, null).toURL();
	...
	private String searchInputStreams(){
		...
		try{
			/*TODO: get rid of this hardcoded URL*/
			URL obj = new URI(PROTOCOL, null, HOST, PORT, PATH, INPUT_STREAM_QUERY, null).toURL();
